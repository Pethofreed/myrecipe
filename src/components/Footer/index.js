  ...
  return (
    <Row className="row-footer">
      ...
      <Col className="column-three">
        <a href="https://github.com/Pethofreed" target="_blank">
          <img src={Github} alt="logo-github" className="icon-red-social"/>
        </a>
        <a href="https://www.linkedin.com/in/carlosvalenciahenao/" target="_blank">
          <img src={Linkedin} alt="logo-linkedin" className="icon-red-social"/>
        </a>
        <a href="https://www.instagram.com/kingcharlie94/" target="_blank">
          <img src={Instagram} alt="logo-instagram" className="icon-red-social-instagram"/>
        </a>
        <a href="https://www.youtube.com/channel/UCcMkIwFJxNth6-VXTzOMoWg/videos" target="_blank">
